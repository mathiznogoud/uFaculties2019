...
(function ($) {
    ...
    $.artaraxTreeView = function (options) {
        ...
        function appendTreeItem(obj, hasChildren, checkedAttribute) {
            var selectedClass = 'style="margin-left:50px;"';
            var updatableHtml = '';
            var deletableHtml = '';
            ...
            if (isUpdatable) {
                updatableHtml = '<img class="mng-img node-update" data-id="' + obj.Id + '" src="https://www.jqueryscript.net/demo/Tree-Selection-Control-ArtaraxTreeView/artarax-treeview/images/update.png"/>';
            }

            if (isDeletable) {
                deletableHtml = '<img class="mng-img node-delete" data-id="' + obj.Id + '" src="https://www.jqueryscript.net/demo/Tree-Selection-Control-ArtaraxTreeView/artarax-treeview/images/delete.png"/>';
            }
